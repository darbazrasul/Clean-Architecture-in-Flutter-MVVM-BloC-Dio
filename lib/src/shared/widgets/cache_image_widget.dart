...
class CachedImage extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            if (errorText.isNotEmpty) ...[
              CustomSpacer.vertical(space: 8.h),
  ...
  Widget build(BuildContext context) {
    ...
    // Apply tap functionality if specified
    if (onTap != null) {
...
extension CachedImageExtensions on CachedImage {
  /// Creates a cached image with custom loading and error states
